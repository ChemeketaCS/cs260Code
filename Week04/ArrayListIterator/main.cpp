...
int main() {
  ...
  for (ArrayListIterator<int> it = myList.begin(); it != myList.end(); ++it) {
    cout << *it << " ";
  }
  cout << endl;
  ...
  cout << "---------Use some other std::algorithms with "
          "ArrayListIterator---------"
       << endl;
  cout << "Max value: " << *std::max_element(myList.begin(), myList.end())
       << endl;
